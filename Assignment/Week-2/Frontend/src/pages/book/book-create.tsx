...
import { TagsInput, Button, Checkbox, Container, Divider, NumberInput, TextInput } from "@mantine/core";
      ...
      <Layout>
        <Container className="mt-8">
          ...
          <form onSubmit={bookCreateForm.onSubmit(handleSubmit)} className="space-y-8">
            ...
            {/* TODO: new */}
            <TagsInput label="หมวดหมู่" placeholder="พิมพ์หมวดหมู่และกด Enter" {...bookCreateForm.getInputProps("category")} splitChars={[',']} />
